...
class PropagateHintsPass
    : public mlir::impl::TritonReorderBroadcastBase<PropagateHintsPass> {
  public:
    void runOnOperation() override {
...
std::unique_ptr<mlir::Pass> mlir::triton::createPropagateHintsPass() {
  return std::make_unique<PropagateHintsPass>();
}
